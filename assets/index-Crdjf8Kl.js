...
`;function Pr(e){return Y(()=>{console.log("Layout 컴포넌트 나타남"),J(()=>{console.log("Layout cleanUp 함수")})}),a(yr,{get children(){return a(wr,{get children(){return[a(fr,{}),a(vr,{get children(){return e.children}}),a(xr,{})]}})}})}var Sr=_("<h4>메인 페이지");const $r=b.div`
  position: fixed;
  top: 5.0vh;
  min-height: 91.6vh;
  left: 0;
...
`;function Ar(){return Y(()=>{console.log("Main 시작"),J(()=>{console.log("Main 소멸")})}),a($r,{get children(){return Sr()}})}var Cr=_("<h4>테스트 페이지");const Lr=b("div")`
  position: fixed;
  top: 5.0vh;
  min-height: 91.6vh;
  left: 0;
...
`,kr=b("div")`
  ...
  align-items: center;
  color: white;
`;function ee(){return Ze(),Y(()=>{console.log("Test 시작"),J(()=>{console.log("Test 소멸")})}),a(Lr,{get children(){return a(kr,{get children(){return Cr()}})}})}var _r=_("<div>에 <!>원을 베팅하세요."),Er=_("<div>게임 결과:"),Or=_("<h3>베팅 기록"),Rr=_("<ul>"),Br=_("<li>");const Tr=b("div")`
  position: fixed;
  top: 5vh;
  left: 0;
  width: 100%;
...
`;function oo(){const[e,t]=L(""),[n,o]=L({val1:0,val2:0,val3:0}),[r,i]=L(""),[s,l]=L(""),[c,f]=L({val1:0,val2:0,val3:0}),d=u=>u<2e3?1:u<5e3?5:u<2e4?10:u<5e4?50:u<2e5?100:u<5e5?500:1e3,g=u=>{const h=d(u);return Math.floor(u/h)*h};return Y(()=>{const u=parseFloat(e());if(!isNaN(u)){const h=m=>g(u*m);o({val1:h(.77),val2:h(.693),val3:h(.65835)})}}),Y(()=>{const u=parseFloat(r()),h=parseFloat(s());if(!isNaN(u)&&!isNaN(h)){const m=(u+h)/2,x=w=>g(w);f({val1:x((m+u)/2),val2:x(m),val3:x((m+h)/2)})}}),a(ro,{get children(){return[a(pt,{children:"💰 가격 전환 계산기"}),a(ht,{get children(){return a(gt,{get children(){return[(()=>{var u=Xr(),h=u.firstChild;return u.style.setProperty("display","flex"),u.style.setProperty("gap","20px"),C(h,a(Ne,{children:"기준가:"}),null),C(h,a(je,{type:"number",get value(){return e()},onInput:m=>t(m.target.value),placeholder:"기준가 입력"}),null),u})(),a(mt,{get children(){return[(()=>{var u=Yr(),h=u.firstChild,m=h.nextSibling;return m.nextSibling,C(u,a(se,{get children(){return n().val1}}),m),u})(),(()=>{var u=Jr(),h=u.firstChild,m=h.nextSibling;return m.nextSibling,C(u,a(se,{get children(){return n().val2}}),m),u})(),(()=>{var u=Qr(),h=u.firstChild,m=h.nextSibling;return m.nextSibling,C(u,a(bt,{get children(){return n().val3}}),m),u})()]}})]}})}}),a(pt,{children:"📊 고가-저가 분석기"}),a(ht,{get children(){return a(gt,{get children(){return[(()=>{var u=Zr(),h=u.firstChild,m=h.nextSibling;return u.style.setProperty("display","flex"),u.style.setProperty("gap","20px"),C(h,a(Ne,{children:"고가:"}),null),C(h,a(je,{type:"number",get value(){return r()},onInput:x=>i(x.target.value),placeholder:"고가 입력"}),null),C(m,a(Ne,{children:"저가:"}),null),C(m,a(je,{type:"number",get value(){return s()},onInput:x=>l(x.target.value),placeholder:"저가 입력"}),null),u})(),a(mt,{get children(){return[(()=>{var u=eo(),h=u.firstChild,m=h.nextSibling;return m.nextSibling,C(u,a(se,{get children(){return c().val1}}),m),u})(),(()=>{var u=to(),h=u.firstChild,m=h.nextSibling;return m.nextSibling,C(u,a(se,{get children(){return c().val2}}),m),u})(),(()=>{var u=no(),h=u.firstChild,m=h.nextSibling;return m.nextSibling,C(u,a(bt,{get children(){return c().val3}}),m),u})()]}})]}})}}),a(Kr,{})]}})}function io(){return Y(()=>{console.log("App 컴포넌트 나타남"),J(()=>{console.log("App cleanUp 함수")})}),a(or,{get children(){return a(j,{path:"/",component:Pr,get children(){return[a(j,{path:"/",component:Ar}),a(j,{path:"/trends",component:ee}),a(j,{path:"/custom",component:ee}),a(j,{path:"/signin",component:ee}),a(j,{path:"/signup",component:ee}),a(j,{path:"/test",component:ee}),a(j,{path:"/testbet",component:Vr}),a(j,{path:"/stockcalc",component:oo}),a(j,{path:"/*",component:ee})]}})}})}const so=b.div`
  * {
    margin: 0;
    padding: 0;
    box-sizing: border-box;
